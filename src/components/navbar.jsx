...
const classes = {
  container: 'font-mono fixed top-0 max-sm:h-[40px] md:h-[60px] left-0 right-0 flex mt-[20px] mx-auto px-4 rounded-[30px] bg-white/3 backdrop-blur-md h-[60px] w-[90%] justify-between items-center z-[1000]',
