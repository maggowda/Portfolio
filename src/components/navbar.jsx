...
const classes = {
  container: 'font-mono fixed top-0 max-sm:h-[40px] md:h-[60px] md:w-[95%] lg:w-[85%] left-0 right-0 flex mt-[20px] mx-auto max-sm:px-0 max-sm:w-[95%] px-4 rounded-[30px] bg-white/3 backdrop-blur-md lg:h-[60px] w-[90%] justify-between items-center z-[1000]',
