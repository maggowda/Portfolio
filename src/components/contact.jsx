...
const style = {
  ...
  inside: 'w-[145px] h-[30px] text-[10px] lg:w-[240px] lg:h-[50px] md:w-[280px] md:h-[50px] sm:w-[175px] md:text-[18px] sm:h-[35px] sm:text-[13px] rounded-[10px] bg-[#141414] border-solid border-[1px] border-zinc-800 text-white text-[16px] px-[15px] lg:mt-[10px] md:mt-[10px] sm:mt-[10px] mt-[5px] hover:border-[#141414]',
  inside1: 'lg:w-[500px] lg:h-[50px] md:w-[575px] md:h-[50px] rounded-[10px] md:text-[18px] bg-[#141414] w-[310px] sm:w-[380px] sm:text-[13px] sm:h-[35px] border-solid border-[1px] border-zinc-800 text-white lg:text-[18px] text-[10px] h-[32px] px-[15px] lg:mt-[10px] md:mt-[10px] sm:mt-[10px] mt-[5px] hover:border-[#141414]',
  inside2: 'lg:w-[470px] lg:h-[50px] md:w-[550px] md:h-[50px] text-white md:text-[18px] lg:text-[16px] sm:text-[13px] w-[280px] sm:w-[355px] sm:h-[35px] h-[30px] bg-[#141414]',
