...
const style = {
  ...
  p: 4,
  button: 'bg-zinc-800 hover:bg-[#006cff] max-sm:mr-[37px] md:mr-[-30px] w-[50px] max-sm:mt-[-9px] h-[50px] rounded-full mt-[-12px] ml-[-40px] mr-[-45px] cursor-pointer flex justify-center items-center',
  span: 'text-[#006cff] mt-[30px] max-sm:text-[18px] ml-[-22px] text-[20px] px-[20px]',
  img: 'w-[280px] h-[280px] max-sm:mr-[105px] rounded-[30px] mt-[30px] mx-auto',
  img1: 'w-[25px] h-[25px]',
  para: 'text-white text-left mt-[40px] max-sm:text-[16px] px-[20px] text-[17px]',
  container1: 'flex flex-row justify-between w-[600px]',
  container: 'flex flex-col w-[730px] max-sm:w-[560px] md:w-[700px] max-sm:h-[700px] md:h-[690px] h-[660px] items-center bg-black rounded-[30px] border-solid border-[1px] border-zinc-800',
