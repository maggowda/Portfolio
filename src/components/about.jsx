...
const style = {
  ...
  p: 4,
  button: 'bg-zinc-800 hover:bg-[#006cff] sm:mr-[20px] sm:w-[40px] sm:h-[40px] lg:w-[50px] lg:h-[50px] md:h-[50px] md:w-[50px] h-[40px] w-[40px] mr-[17px] sm:mt-[-9px]  md:mr-[-15px] rounded-full mt-[-12px] lg:ml-[-40px] lg:mr-[-45px] cursor-pointer flex justify-center items-center',
  ...
  img1: 'md:w-[25px] md:h-[25px] lg:w-[25px] lg:h-[25px] w-[20px] h-[20px] sm:w-[20px] sm:h-[20px] ',
