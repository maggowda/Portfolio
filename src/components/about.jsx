...
const style = {
  ...
  p: 4,
  button: 'bg-zinc-800 hover:bg-[#006cff] max-sm:mr-[20px] max-md:mr-[-30px] max-sm:w-[40px] max-sm:h-[40px] w-[50px] max-sm:mt-[-9px] h-[50px] rounded-full mt-[-12px] ml-[-40px] mr-[-45px] cursor-pointer flex justify-center items-center',
  ...
  container1: 'flex flex-row justify-between max-sm:w-[400px] lg:w-[600px] max-md:w-[600px]',
  container: 'flex flex-col lg:w-[730px] max-sm:w-[400px] max-md:w-[600px] max-sm:h-[500px] max-md:h-[690px] h-[660px] items-center bg-black rounded-[30px] border-solid border-[1px] border-zinc-800',
