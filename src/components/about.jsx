...
const style = {
  ...
  p: 4,
  button: 'bg-zinc-800 hover:bg-[#006cff] max-sm:mr-[105px] md:mr-[-30px] w-[50px] max-sm:mt-[-9px] h-[50px] rounded-full mt-[-12px] ml-[-40px] mr-[-45px] cursor-pointer flex justify-center items-center',
  span: 'text-[#006cff] mt-[30px] max-sm:text-[16px] ml-[-22px] text-[20px] px-[20px]',
  img: 'w-[280px] h-[280px] max-sm:w-[180px] max-sm:h-[180px] max-sm:ml-[140px] rounded-[30px] mt-[30px] mx-auto',
  img1: 'w-[25px] h-[25px]',
