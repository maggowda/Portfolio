...
const classes = {
  ...
  card: 'w-[200px] h-[130px] sm:w-[200px] sm:h-[130px] md:w-[365px] md:h-[230px] lg:w-[340px] lg:h-[230px] rounded-[15px] sm:rounded-[15px] md:rounded-[30px] lg:rounded-[30px] bg-zinc-700 flex-col flex justify-center items-center cursor-pointer bg-cover',
