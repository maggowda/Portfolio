...
const Engineer = () => {
  ...
  return (
    <div className={classes.container}>
      ...
      <motion.a variants={fromBottom} initial='hidden' whileInView={'show'} whileTap={{scale: 0.9}} whileHover={{scale:1.05}} href='https://drive.google.com/file/d/1i-2FMdi6q00ZCdqNKfmIuguiPA9i90pK/view?usp=sharing' target='_blank' className={classes.button}>Download Resume<span><img src={arrow} className={classes.img}/></span></motion.a>
    </div>
  )
}
