...
const classes = {
  ...
  jap: 'text-[#006cff] text-[8.5vh] max-sm:text-[35px]',
  h1: 'text-[50px] mt-[195px] font-medium max-sm:text-[35px]',
  h2: 'text-[140px] font-semibold max-sm:text-[70px]',
  ...
  div0: 'flex max-sm:w-[410px] max-sm:h-[580px] flex-col items-center justify-center w-[1120px] h-[630px] mt-[120px] mb-[50px] border-zinc-800 border-solid border-[2px] rounded-[50px] z-30',
  div3: 'w-[1120px] max-sm:w-[410px] max-sm:h-[580px] h-[630px] rounded-[50px] bg-zinc-700 sticky top-[110px] max-sm:top-[70px] z-20 border-solid border-[2px] border-white',
  div3_1: 'w-[1120px] max-sm:w-[410px] h-[630px] max-sm:h-[580px] rounded-[50px] bg-zinc-700 sticky top-[125px] max-sm:top-[80px] z-30 border-solid border-[2px] border-white',
  div3_2: 'w-[1120px] max-sm:w-[410px] h-[630px] rounded-[50px] max-sm:h-[580px] bg-zinc-700 sticky top-[140px] max-sm:top-[90px] z-40 border-solid border-[2px] border-white',
  div3_3: 'w-[1120px] max-sm:w-[410px] h-[630px] rounded-[50px] max-sm:h-[580px] bg-zinc-700 sticky top-[110px] max-sm:top-[100px] z-50 border-solid border-[2px] border-white', 
}
function Landing() {
