...
const classes = {
  ...
  h5: 'text-[90px] mt-[-30px] text-center max-sm:text-[45px]',
  ...
  button2: 'flex flex-row max-sm:h-[50px] max-sm:w-[290px] justify-center max-sm:text-[16px] items-center  h-[70px] w-[350px] text-[20px] my-[50px] text-semibold bg-[#141414] border-solid inline border-[2px] border-zinc-700 hover:border-[#006cff] rounded-[45px] hover:bg-[#006cff] cursor-pointer',
  ...
  div0: 'flex max-sm:w-[410px] max-sm:h-[580px] flex-col md:h-[560px] md:w-[700px] items-center justify-center lg:w-[1120px] lg:h-[630px] mt-[120px] mb-[50px] border-zinc-800 border-solid border-[2px] rounded-[50px] z-30',
  div3: 'lg:w-[1120px] max-sm:w-[410px] md:w-[700px] max-sm:h-[580px] md:h-[560px] lg:h-[630px] rounded-[50px] bg-zinc-700 sticky lg:top-[110px] md:top-[85px] max-sm:top-[70px] z-20 border-solid border-[2px] border-white',
  div3_1: 'lg:w-[1120px] max-sm:w-[410px] lg:h-[630px] md:w-[700px] md:h-[560px] max-sm:h-[580px] rounded-[50px] bg-zinc-700 sticky lg:top-[125px] md:top-[95px] max-sm:top-[80px] z-30 border-solid border-[2px] border-white',
  div3_2: 'lg:w-[1120px] max-sm:w-[410px] lg:h-[630px] md:w-[700px] md:h-[560px] rounded-[50px] max-sm:h-[580px] bg-zinc-700 sticky lg:top-[140px] md:top-[105px] max-sm:top-[90px] z-40 border-solid border-[2px] border-white',
  div3_3: 'lg:w-[1120px] max-sm:w-[410px] lg:h-[630px] md:w-[700px] md:h-[560px] rounded-[50px] max-sm:h-[580px] bg-zinc-700 sticky lg:top-[110px] md:top-[115px] max-sm:top-[100px] z-50 border-solid border-[2px] border-white', 
}
function Landing() {
